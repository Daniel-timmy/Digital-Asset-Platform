      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 relative z-10">
        ...
        <div className="mb-8 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <svg className="w-32 h-32 text-gray-400 animate-bounce" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 p-6 bg-white rounded-2xl shadow-lg border border-gray-100 max-w-md">
          ...
          <div className="flex items-center justify-center gap-4">
            <a href="mailto:support@baselinks.com" className="text-black font-semibold hover:underline text-sm">
              Contact Support
            </a>
            <span className="text-gray-300">|</span>
            <Link to="/categories" className="text-black font-semibold hover:underline text-sm">
              View Categories
            </Link>
          </div>
        </div>
